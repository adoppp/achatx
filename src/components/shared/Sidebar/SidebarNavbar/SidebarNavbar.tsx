...
import styles from '@/components/shared/Sidebar/SidebarNavbar/SidebarNavbar.module.scss';

import { navbarConfig } from '@/components/shared/Sidebar/SidebarNavbar/SidebarNavbar.config';
