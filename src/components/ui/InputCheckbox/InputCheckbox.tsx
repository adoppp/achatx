...
import styles from '@/components/ui/InputCheckbox/InputCheckbox.module.scss';
    ...
    return (
        <label htmlFor={id} className={cn('checkbox__container')}>
            <span
                className={cn(
                    'checkbox__label',
                    checkMarkPosition === 'left' && 'checkbox__label-left',
                )}
            >
                {label}
            </span>
            ...
            <span
                className={cn(
                    'checkbox__checkmark',
                    checkMarkPosition === 'right' && 'checkbox__checkmark-right',
                )}
            ></span>
        </label>
    );
